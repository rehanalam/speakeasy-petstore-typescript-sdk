...
export function petsAdd(
  ...
  Result<
    operations.AddPetResponse | undefined,
    | PetstoreError
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AddPetResponse$inboundSchema.optional()),
    M.bytes(200, operations.AddPetResponse$inboundSchema.optional(), {
      ctype: "application/xml",
    }),
    M.fail([400, 422, "4XX"]),
    M.fail("5XX"),
    M.nil("default", operations.AddPetResponse$inboundSchema.optional()),
  )(response, req);
  if (!result.ok) {
