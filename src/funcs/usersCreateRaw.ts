 ...
 */
export function usersCreateRaw(
  client: PetstoreCore,
  request?:
...
> {
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.CreateUserRawResponse$inboundSchema.optional()),
    M.bytes(200, operations.CreateUserRawResponse$inboundSchema.optional(), {
      ctype: "application/xml",
    }),
    M.fail("4XX"),
    M.fail("5XX"),
    M.nil("default", operations.CreateUserRawResponse$inboundSchema.optional()),
  )(response);
  if (!result.ok) {
