...
> {
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.GetOrderByIdResponse$inboundSchema.optional()),
    M.bytes(200, operations.GetOrderByIdResponse$inboundSchema.optional(), {
      ctype: "application/xml",
    }),
    M.fail([400, 404, "4XX"]),
    M.fail("5XX"),
    M.nil("default", operations.GetOrderByIdResponse$inboundSchema.optional()),
  )(response);
  if (!result.ok) {
