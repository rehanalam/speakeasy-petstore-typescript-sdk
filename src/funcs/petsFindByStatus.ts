...
> {
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.FindPetsByStatusResponse$inboundSchema.optional()),
    M.bytes(200, operations.FindPetsByStatusResponse$inboundSchema.optional(), {
    ...
    M.nil(
      "default",
      operations.FindPetsByStatusResponse$inboundSchema.optional(),
    ),
  )(response);
  if (!result.ok) {
