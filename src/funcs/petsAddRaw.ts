...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AddPetRawResponse$inboundSchema.optional()),
    M.bytes(200, operations.AddPetRawResponse$inboundSchema.optional(), {
      ctype: "application/xml",
    }),
    M.fail([400, 422, "4XX"]),
    M.fail("5XX"),
    M.nil("default", operations.AddPetRawResponse$inboundSchema.optional()),
  )(response, req);
  if (!result.ok) {
