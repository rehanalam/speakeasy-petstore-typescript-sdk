...
> {
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.UpdatePetRawResponse$inboundSchema.optional()),
    M.bytes(200, operations.UpdatePetRawResponse$inboundSchema.optional(), {
      ctype: "application/xml",
    }),
    M.fail([400, 404, 422, "4XX"]),
    M.fail("5XX"),
    M.nil("default", operations.UpdatePetRawResponse$inboundSchema.optional()),
  )(response);
  if (!result.ok) {
