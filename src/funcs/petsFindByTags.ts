...
> {
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.FindPetsByTagsResponse$inboundSchema.optional()),
    M.bytes(200, operations.FindPetsByTagsResponse$inboundSchema.optional(), {
    ...
    M.nil(
      "default",
      operations.FindPetsByTagsResponse$inboundSchema.optional(),
    ),
  )(response);
  if (!result.ok) {
