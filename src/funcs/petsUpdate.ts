...
export function petsUpdate(
  ...
  Result<
    operations.UpdatePetResponse | undefined,
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.UpdatePetResponse$inboundSchema.optional()),
    M.bytes(200, operations.UpdatePetResponse$inboundSchema.optional(), {
      ctype: "application/xml",
    }),
    M.fail([400, 404, 422, "4XX"]),
    M.fail("5XX"),
    M.nil("default", operations.UpdatePetResponse$inboundSchema.optional()),
  )(response);
  if (!result.ok) {
