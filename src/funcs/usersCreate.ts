...
export function usersCreate(
  ...
  Result<
    operations.CreateUserResponse | undefined,
    | PetstoreError
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.CreateUserResponse$inboundSchema.optional()),
    M.bytes(200, operations.CreateUserResponse$inboundSchema.optional(), {
      ctype: "application/xml",
    }),
    M.fail("4XX"),
    M.fail("5XX"),
    M.nil("default", operations.CreateUserResponse$inboundSchema.optional()),
  )(response, req);
  if (!result.ok) {
