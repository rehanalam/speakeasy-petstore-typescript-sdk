...
export enum UpdateWithFormAcceptEnum {
 ...
 */
export function petsUpdateWithForm(
  client: PetstoreCore,
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdatePetWithFormResponse$inboundSchema.optional()),
    M.bytes(
      200,
      operations.UpdatePetWithFormResponse$inboundSchema.optional(),
