 ...
 */
export function petsUpdateForm(
  client: PetstoreCore,
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdatePetFormResponse$inboundSchema.optional()),
    M.bytes(200, operations.UpdatePetFormResponse$inboundSchema.optional(), {
      ctype: "application/xml",
    }),
    M.fail([400, 404, 422, "4XX"]),
    M.fail("5XX"),
    M.nil("default", operations.UpdatePetFormResponse$inboundSchema.optional()),
  )(response, req);
  if (!result.ok) {
