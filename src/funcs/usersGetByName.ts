 ...
 */
export function usersGetByName(
  client: PetstoreCore,
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetUserByNameResponse$inboundSchema.optional()),
    M.bytes(200, operations.GetUserByNameResponse$inboundSchema.optional(), {
      ctype: "application/xml",
    }),
    M.fail([400, 404, "4XX"]),
    M.fail("5XX"),
    M.nil("default", operations.GetUserByNameResponse$inboundSchema.optional()),
  )(response, req);
  if (!result.ok) {
